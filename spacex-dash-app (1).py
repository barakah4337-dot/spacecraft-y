...
# Read the spacecraft data into pandas dataframe
...
# Payload range slider with label
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(
           spacex_df[spacex_df['class'] == 1],  # only successes
           names='Launch Site',
        ...
        # Create pie chart showing success vs failure counts
        fig = px.pie(
            filtered_df,
